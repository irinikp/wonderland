...
class NumberOperatorTest extends TestCase
{
    ...
    {
        $number = 12333;
        self::assertEquals(5, NumberOperator::getNumberOfDigits($number));
    }

    public function testNumberOfDigitsReturnsOneOnOneDigitsNumber()
    {
        $number = 8;
        self::assertEquals(1, NumberOperator::getNumberOfDigits($number));
    }
    ...
    public function testHasAllTheSameDigitsReturnsTrueWhenInputArgsHaveSameDigits()
    {
        $number1 = 12345;
        $number2 = 54231;
        $this->assertTrue(NumberOperator::hasAllTheSameDigits($number1, $number2));
    }
    ...
    public function testHasAllTheSameDigitsReturnsFalseWhenInputArgsDontHaveSameDigits()
    {
        $number1 = 12345;
        $number2 = 54261;
        $this->assertFalse(NumberOperator::hasAllTheSameDigits($number1, $number2));
    }
